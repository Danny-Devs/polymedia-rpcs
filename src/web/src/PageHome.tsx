...
export const PageHome: React.FC = () => {
  ...
  return (
    <>
      <h1>
        <span className="rainbow">Sui RPC tools</span>
      </h1>

      <div className="section">
        <h2>
          <span className="rainbow">LATENCY TEST</span>
        </h2>

        <p style={{ paddingBottom: '0.5rem' }}>
          Select the RPCs you want to test:
        </p>
      ...
      {results.length > 0 && (
        <div className="section">
          <h2>
            <span className={`rainbow ${isRunning ? 'running' : ''}`}>
              RESULTS
            </span>
          </h2>
      ...
      <div className="section">
        ...
        <div className="tight">
          <p>
            ▸ The app sends {numRounds - 1} requests to each RPC and measures
            the response times (latency). The results are shown in milliseconds.
          </p>
          <p>▸ "AVG" is the average latency of all requests sent to the RPC.</p>
          <p>
            ▸ "P50" is the 50th percentile (median) latency for the RPC. This
            means 50% of the requests were faster.
          </p>
          <p>
            ▸ "P90" is the 90th percentile latency for the RPC. This means 90%
            of the requests were faster.
          </p>
        </div>
      </div>
      ...
      <div className="section">
        <h2>
          <span className="rainbow">DEV TOOLS</span>
        </h2>

        <p>
          The NPM package{' '}
          <b>
            <i>@polymedia/suitcase-core</i>
          </b>{' '}
          provides functions to measure RPC latency and instantiate{' '}
          <i>SuiClient</i> using the lowest latency endpoint for each user:{' '}
          <b>
            <i>measureRpcLatency()</i>
          </b>{' '}
          and{' '}
          <b>
            <i>newLowLatencySuiClient()</i>
          </b>
          .
        </p>
        <p>
